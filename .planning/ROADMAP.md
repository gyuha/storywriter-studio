...
- [x] **Phase 1: 인증 연동** - 프론트엔드-백엔드 실제 인증 연결 (mock 제거)
- [x] **Phase 2: 소설/챕터 관리** - 소설 프로젝트와 챕터 CRUD, TipTap 에디터 기본 동작
- [x] **Phase 3: 세계관 데이터베이스** - 캐릭터/장소/세계관 설정 CRUD 및 관계 관리
- [x] **Phase 4: 에디터 사이드패널 + AI 초안 생성** - 핵심 가치 실현: 세계관 컨텍스트가 AI에 자동 주입되어 챕터 초안 생성
...
|-------|----------------|--------|-----------|
| 1. 인증 연동 | 4/4 | ✅ Done | 2026-05 |
| 2. 소설/챕터 관리 | 4/4 | ✅ Done | 2026-05 |
| 3. 세계관 데이터베이스 | 3/3 | ✅ Done | 2026-05 |
| 4. 에디터 사이드패널 + AI 초안 생성 | 2/2 | ✅ Done | 2026-05-20 |
